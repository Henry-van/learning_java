...
public class MyTreeCellRenderer extends JLabel implements TreeCellRenderer {
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        Icon icon = null;
        // By Guanghe Start **********************************************************
//        Icon rootIcon = new ImageIcon(ROOT_PATH + ASSETS_PATH + "mailBox.png");
        Icon rootIcon = new ImageIcon("." + ASSETS_PATH + "mailBox.png");
        Icon newIcon = new ImageIcon("." + ASSETS_PATH + "newMail.png");
        Icon receiveIcon = new ImageIcon("." + ASSETS_PATH + "receive.png");
        Icon sendIcon = new ImageIcon("." + ASSETS_PATH + "send.png");
        Icon deleteIcon = new ImageIcon("." + ASSETS_PATH + "delete.png");
